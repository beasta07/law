...
const Products = () => {
  ...
  const cakeData = [
    ...
    },
    {
      ...
      name: "Choclate cake",
      price: "Rs 1200/pound",
      background: "/images/Products/Third.jpeg"
    },
    {
      title: "Cake",
      name: "Orange cake",
      price: "Rs 1200/pound",
      background: "/images/Products/Second.jpeg"
    },
    {
      title: "Cake",
      name: "Blueberry cake",
  ...
  return (
    <div className="container font-poppins pt-32 px-4  ">
      <div className="mb-20 text-center ">
        <h1 className="font-cyrene text-5xl ">Some of Our </h1>
        <h2 className="text-lg text-[#9A3324]">Best Products</h2>
      </div>
